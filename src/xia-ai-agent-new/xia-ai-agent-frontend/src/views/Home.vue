  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">xiapi AI超级智能体</h1>
      </div>
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/property-master')">
        <div class="card-glow"></div>
        <div class="app-icon property-icon">🏠</div>
        <div class="app-info">
          <div class="app-title">AI房产分析助手</div>
          <div class="app-desc">智能房产顾问，帮你解答房产问题</div>
        </div>
...
// 设置页面标题和元数据
useHead({
  title: 'xiapi AI超级智能体应用平台 - 首页',
  meta: [
    {
      name: 'description',
      content: 'xiapi AI超级智能体应用平台提供AI房产分析助手和AI超级智能体服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
      content: 'AI智能体,AI应用,AI房产分析助手,AI助手,智能对话,xiapi,AI超级智能体,首页'
    }
  ]
})
